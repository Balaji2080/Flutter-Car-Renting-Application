import 'package:car/NextToLogin/booked_car.dart';
...
class _BookCarState extends State<BookCar> {
              ...
              child: Center(
                child: Padding(
                  ...
                  child: ButtonTheme(child: Container(
                    ...
                    onPressed: () { Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => SuccesfullyBooked())); },
                        color: kPrimaryColor,
                    child: new Text("Book this car",
                    style: TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 16
  ...
  Widget buildPricePerPeriod(String Week, String price, bool selected){
    return Expanded(
      child: Container(
        height: 80,
        padding: EdgeInsets.all(16),
